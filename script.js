...
console.log(new Date(2037, 10, 19, 15, 12, 8));
...
console.log(new Date(1698183292069));
...
const days1 = calcDaysPassed(new Date(203, 3, 4), new Date(2037, 3, 14));
console.log(days1);
*/
